...
@Constraint(validatedBy = NombradoJugadorValidador.class)
@Documented
public @interface NombradoJugador {

    //Definimos el mensaje por defecto
    String message() default "{es.etg.daw.dawes.java.rest.academia.jugadores.infraestructure.web.validation.NombradoJugador}";
